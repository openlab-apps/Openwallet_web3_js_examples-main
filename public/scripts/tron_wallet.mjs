...
async function tronRequestAccount() {
    let accounts = await window.tron.sendWalletRequest({ method: "tron_requestAccounts" });
...
async function getTronWeb() {
    ...
    throw new Error("Tron web does not exists.")
...
async function createIssue() {
    ...
    const transaction = await tron.transactionBuilder.createAsset(
        trc_options,
        account
    )
    const result = await window.tron.sendWalletRequest({ method: "tron_signTransaction", params: [transaction] });
...
async function sendTrc10() {
    ...
    const account = tron.defaultAddress?.base58;
    const transaction = await tron.transactionBuilder.sendToken(to, 100, "1001470", account);
    const result = await window.tron.sendWalletRequest({ method: "tron_signTransaction", params: [transaction] });
    parseResult(result)
}
async function freezeBalanceV2() {
    let tron = await getTronWeb();
    const account = tron.defaultAddress?.base58;
    const transaction = await tron.transactionBuilder.freezeBalanceV2(100000000, undefined, account);
    const result = await window.tron.sendWalletRequest({ method: "tron_signTransaction", params: [transaction] });
    parseResult(result)
}
async function delegateResource() {
    let tron = await getTronWeb();
    const account = tron.defaultAddress?.base58;
    const transaction = await tron.transactionBuilder.delegateResource(10000000, "THEYs5NZFgi3ZQC7BQhk7mt4DjTVWGzzdJ", "BANDWIDTH", account, true, 86400);
    const result = await window.tron.sendWalletRequest({ method: "tron_signTransaction", params: [transaction] });
    parseResult(result)
}
async function accountPermission() {
    let tron = await getTronWeb();
    const ownerAddress = tron.defaultAddress?.base58;
    ...
    const transaction = await tron.transactionBuilder.updateAccountPermissions(ownerAddress, ownerPermission, null, [activePermission]);
    const result = await window.tron.sendWalletRequest({ method: "tron_signTransaction", params: [transaction] });
    parseResult(result)
}
